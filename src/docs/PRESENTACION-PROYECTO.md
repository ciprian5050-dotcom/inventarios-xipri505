...
1. **Dashboard** (`/components/DashboardScreen.tsx`)
   - Vista general del sistema
   - Métricas y estadísticas
   - Acceso rápido a módulos

2. **Activos** (`/components/ActivosScreen.tsx`)
   - Listado completo de activos
   - Búsqueda y filtros avanzados
   - CRUD completo de activos
   - Visualización de códigos QR

3. **Ingresos** (`/components/IngresosScreen.tsx`)
   - Registro de compras
   - Datos de factura y proveedor
   - Historial de ingresos
   - Vista detallada de facturas

4. **Reportes** (`/components/ReportesScreen.tsx`)
   - Generación de informes PDF
   - Filtros: cuentadante, dependencia, estado
   - Exportación personalizada

5. **Configuración** (`/components/ConfiguracionScreen.tsx`)
...
6. **QR** (`/components/QRConfigScreen.tsx`)
